        ...
        <div className="flex flex-col gap-3 sm:flex-row sm:gap-4">
          ...
          >
            <Link
              ...
              target="_blank"
              className="inline-flex items-center justify-center gap-2 px-4 sm:px-6 py-3 border border-black/30 text-white rounded-lg font-medium bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 w-full min-h-[44px]"
            >
              <Linkedin size={18} />
